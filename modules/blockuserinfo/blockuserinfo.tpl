...
<div id="header_user" {if $PS_CATALOG_MODE}class="header_user_catalog"{/if}>
    ...
    <p id="header_user_info">
        ...
        {else}
            <a href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Login to your customer account' mod='blockuserinfo'}" class="pame-login" rel="nofollow">{l s='Login' mod='blockuserinfo'}</a>
        {/if}
    </p>
</div>
<!-- /Block user information module HEADER -->
